...
var noEmails string = `{"Id":1,"Name":"Howard Mendoza","Username":"0Oliver","Phone":"6-866-899-36-79","Password":"InAQJvsq","Address":"Blackbird Place 25"}
...
var incorrectEmails string = `{"Id":1,"Name":"Howard Mendoza","Username":"0Oliver","Email":"aliquid_qui_eaBrowsedrive.gov","Phone":"6-866-899-36-79","Password":"InAQJvsq","Address":"Blackbird Place 25"}
...
{"Id":3,"Name":"Clarence Olson","Username":"RachelAdams","Email":"RoseSmithBrowsecat.com","Phone":"988-48-97","Password":"71kuz3gA5w","Address":"Monterey Park 39"}
...
{"Id":5,"Name":"Janice Rose","Username":"KeithHart","Email":"nullaLinktype.com","Phone":"146-91-01","Password":"acSBF5","Address":"Russell Trail 61"}`
...
func TestGetDomainStat(t *testing.T) {
	...
	t.Run("no emails", func(t *testing.T) {
		result, err := GetDomainStat(bytes.NewBufferString(noEmails), "gov")
		require.NoError(t, err)
		require.Equal(t, DomainStat{}, result)
	})

	t.Run("incorrect emails", func(t *testing.T) {
		result, err := GetDomainStat(bytes.NewBufferString(incorrectEmails), "gov")
		require.NoError(t, err)
		require.Equal(t, DomainStat{}, result)
	})
}
